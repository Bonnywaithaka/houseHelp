...
function UserAccount() {
  return (
    ...
    >
      <Box sx={{ width: "50%", height: "100%", margin: 2 }}>
        <Card sx={{ backgroundColor: "rgba(0, 0, 0, 0.8)", height: "100%" }}>
          <Box
            sx={{
              height: "70%",
              width: "100%",
      ...
      >
        <Box sx={{ width: "100%", height: "50%", backgroundColor: "unset" }}>
          <Card
            sx={{ backgroundColor: "rgba(0, 0, 0, 0.8)", height: "100%" }}
          ></Card>
        </Box>
        <Box sx={{ width: "100%", height: "50%",padding:"10px 0px 0px 0px" }}>
          <Card sx={{ backgroundColor: "rgba(0, 0, 0, 0.8)", height: "100%" }}>
            Test card 3
          </Card>
        </Box>
